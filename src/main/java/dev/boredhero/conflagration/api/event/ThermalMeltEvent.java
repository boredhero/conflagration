...
/** Fired immediately before extreme radiant heat converts exposed stone to magma. */
public final class ThermalMeltEvent extends Event implements ICancellableEvent {
    ...
    public ThermalMeltEvent(ServerLevel level,
                            BlockPos source,
                            BlockPos target,
